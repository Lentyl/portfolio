...
const SECTIONS = [
    ...
    new Section(
        'Skills',
        "I designed website using a wide range of technologies and solutions that I studied (HTML, React, Redux, React Native, Javascript, Typescript, CSS, SASS, Bootstrap, Node.js, Express, Mongoose,  Firestore, Mongo.db, SQL, Git). I feel much more confident with them now and became a better fit for the Web Developer role. When I design and build application I use new technologies and libraries that I haven't used before. Thanks to this approach I expand my knowledge and familiarise myself with new tools.",
        ''
    ),
    new Section(
        'Projects',
